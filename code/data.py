...
if __name__ == '__main__':
    df_train_click = pd.read_csv('/home/guohong/news_xiangmu/data/train_click_log.csv')
    df_test_click = pd.read_csv('/home/guohong/news_xiangmu/data/testA_click_log.csv')
